...
const size_t   BLOCK_REWARD_LOG_FIX_PRECISION_V3             = 17; // Network hashrates are now way higher than when monetaverde started
...
const uint32_t UPGRADE_HEIGHT_V3                             = 2507230;
...
const std::initializer_list<CheckpointData> CHECKPOINTS = {
    ...
    {1800000, "6fb5d671f441915064514083de0f5678e614dbd9a04e135e49bd670869bdc89f"},
